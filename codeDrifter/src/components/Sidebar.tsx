...
const sidebarItems = [
  ...
  { id: "explore", icon: Search, label: "GitHub Digest", badge: null },
  { id: "maintenance", icon: Wrench, label: "Maintenance", badge: "New" },
  { id: "summarization", icon: Sparkles, label: "AI Summarization", badge: "Beta" },
  { id: "visualizations", icon: BarChart3, label: "Code Visualizations", badge: "New" },
];
